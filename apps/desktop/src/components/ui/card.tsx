...
/**
 * A full-bleed band inside a padding-free Card, separated by a hairline
 * instead of a nested border. Stack these to build list/detail panels.
 */
function CardSection({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card-section"
      className={cn("min-w-0 border-b px-4 py-3 last:border-b-0", className)}
      {...props}
    />
  );
}
